      ...
      >
        ...
        <a href="#home" className="flex items-center gap-2.5 group" id="nav-logo">
          ...
          <div className="flex flex-col">
            <span className="font-display font-bold text-2xl tracking-tight text-brand-blue leading-none uppercase">
              CEETEC
            </span>
            <span className="text-[10px] font-mono tracking-widest text-brand-orange font-bold uppercase mt-0.5">
              University
            </span>
          </div>
        </a>
